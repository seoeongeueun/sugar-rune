...
export function ModalSimple({
  ...
  return (
    ...
    >
      <div className="text-white text-lg w-postcard-height h-fit py-20 rounded-lg flex flex-col items-center justify-center gap-1 tablet:gap-8 border-2 border-white outline-2 outline-night bg-white/30 backdrop-blur-md drop-shadow-2xl">
        <img
