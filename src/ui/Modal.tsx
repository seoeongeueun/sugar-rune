  ...
  return (
    ...
    >
      <form
        ...
        className="pt-24 pl-22 text-white text-lg w-postcard-height h-postcard-height rounded-full bg-night shadow-[30px_30px_0px_40px_var(--gold),31px_31px_20px_44px_rgba(0,0,0,0.2)] drop-shadow-xl flex flex-col items-center justify-center gap-8 border border-white/50"
      >
        <img
        ...
        {isLoginModal && (
          <div className="flex flex-col w-full px-8">
            ...
            <input
              ...
              className="p-1 mt-2 px-4 rounded bg-white/20 border border-white/30 text-lg text-white focus:outline-none focus:ring-2 focus:ring-background"
            />
            {errors.password && (
        ...
        <footer className="text-lg flex flex-row items-center justify-between gap-2 w-2/3">
          ...
          <button
            ...
            className="bg-[url('/hearts/heart_white_icon.png')] bg-no-repeat bg-contain bg-center w-24 h-24 hover:brightness-75"
          >
            <span className="z-10">{modal.buttons[0].label}</span>
          </button>
          <button
            ...
            className="bg-[url('/hearts/heart_purple_icon.png')] bg-no-repeat bg-contain bg-center w-24 h-24 hover:brightness-75"
          >
            <span className="z-10">{modal.buttons[1].label}</span>
          </button>
        </footer>
